...
def _():
    ...
    return go, keras, make_subplots, np, pd, px, sns
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""En la proxima linea, en colab o en jupyter podriamos re utilizar la variable answer, pero marimo mantiene activas todas las variables ya definidas... asi que no te permite re utilizarlas. (asi que usamos answer1 :|)""")
    return
...
def _(go, make_subplots, pd, px):
    ...
    return make_plots, model_info


@app.cell
def _(keras, make_plots, model_info, pd):
...
@app.cell
def _(run_experiment, training_df):
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""Vemos en la evolución de las perdidas, que en la epoch 5 el modelo se estabiliza.""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""En este caso, cambiamos la tasa de aprendizaje a 0.01 y el modelo estabiliza la perdida en el segundo epoch.""")
    return
...
def _(run_experiment, training_df):
    ...
    return features1, model_2


@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""Vemos una perdida mucho menor y la RMSE es de 3.3852 (en el anterior fue de 3.8449, mejorando también)""")
    return


@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""## Part 4 - Validate Model""")
    return


@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""Define functions to make predictions""")
    return
...
def _(np, pd):
    ...
    def show_predictions(output):
      ...
      print(output)
      return
    return predict_fare, show_predictions
...
@app.cell
def _(features1, label, model_2, predict_fare, show_predictions, training_df):
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""Tabla con las predicciones de tarifas por tiempo y distancia.""")
    return
